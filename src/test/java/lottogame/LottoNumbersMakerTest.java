...
public class LotteryNumberMakerTest {
	...
	public void makeLotteryNumbers_1에서45사이_6개의_숫자생성() {
		LotteryNumberGroup lotteryNumbers = LotteryNumberMaker.makelotteryNumbers();

		assertThat(lotteryNumbers.getLotteryNumbers().size()).isEqualTo(SIZE_OF_LOTTERY_NUMBERS);
