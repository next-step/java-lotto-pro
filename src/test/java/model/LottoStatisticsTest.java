...
class LottoStatisticsTest {
	...
	void 당첨결과에_따른_수익률1() {
		...
		BigDecimal result = LottoStatistics.calculateForEarningsRate(matchResult, Money.of(14000));
	...
	void 당첨결과에_따른_수익률2() {
		...
		BigDecimal result = LottoStatistics.calculateForEarningsRate(matchResult, Money.of(1000));
	...
	void 당첨결과에_따른_수익률6() {
		...
		BigDecimal result = LottoStatistics.calculateForEarningsRate(matchResult, Money.of(20000));
