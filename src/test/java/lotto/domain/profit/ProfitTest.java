...
class ProfitTest {
    ...
    public static Stream<Arguments> winningNumbersForZero() {
        return Stream.of(
                Arguments.of(Arrays.asList(17, 18, 19, 20, 27, 28)),
                Arguments.of(Arrays.asList(1, 18, 19, 20, 27, 28)),
                Arguments.of(Arrays.asList(1, 2, 19, 20, 27, 28))
        );
    }

    public static Stream<Arguments> winningNumbersForLossProfit() {
        return Stream.of(
                Arguments.of(Arrays.asList(1, 2, 3, 17, 18, 19), true),
                Arguments.of(Arrays.asList(1, 3, 5, 17, 18, 19), false)
        );
    }
    ...
    void profit1(List<Integer> winningNumbers) {
    ...
    void profit2() {
        List<Integer> winningNumbers = Arrays.asList(1, 2, 3, 17, 18, 19);
        WinningLotto winningLotto = WinningLotto.of(winningNumbers, bonusNumber);
        Profit profit = Profit.of(getTestLottos(), winningLotto);
    ...
    void profit3() {
        List<Integer> winningNumbers = Arrays.asList(1, 3, 5, 17, 18, 19);
        WinningLotto winningLotto = WinningLotto.of(winningNumbers, bonusNumber);
        Profit profit = Profit.of(getTestLottos(), winningLotto);
    ...
    void profit5() {
        List<Integer> winningNumbers = Arrays.asList(1, 2, 3, 4, 18, 19);
        WinningLotto winningLotto = WinningLotto.of(winningNumbers, bonusNumber);
        Profit profit = Profit.of(getTestLottos(), winningLotto);
    ...
    void profit6() {
        List<Integer> winningNumbers = Arrays.asList(11, 12, 13, 14, 15, 18);
        WinningLotto winningLotto = WinningLotto.of(winningNumbers, bonusNumber);
        Profit profit = Profit.of(getTestLottos(), winningLotto);
    ...
    void profit7() {
        List<Integer> winningNumbers = Arrays.asList(21, 22, 23, 24, 25, 28);
        WinningLotto winningLotto = WinningLotto.of(winningNumbers, bonusNumber);
        Profit profit = Profit.of(getTestLottos(), winningLotto);
    ...
    void profit9() {
        List<Integer> winningNumbers = Arrays.asList(1, 2, 3, 4, 5, 12);
        WinningLotto winningLotto = WinningLotto.of(winningNumbers, bonusNumber);
        Profit profit = Profit.of(getTestLottos(), winningLotto);
    ...
    void lossProfit(List<Integer> winningNumbers, boolean expected) {
        WinningLotto winningLotto = WinningLotto.of(winningNumbers, bonusNumber);
        Profit profit = Profit.of(getTestLottos(), winningLotto);
