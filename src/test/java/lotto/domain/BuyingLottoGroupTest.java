...
import lotto.strategy.TestLottoGenerateStrategy;
...
public class BuyingLottoGroupTest {
    ...
    void create(){
        BuyingLottoGroup group = BuyingLottoGroup.create(5, new TestLottoGenerateStrategy());
    ...
    void includeManualLotto(){
        BuyingLottoGroup buyingLottoGroup = BuyingLottoGroup.create(5, new TestLottoGenerateStrategy(),
                Arrays.asList(
