...
class LottoHelperTest {
    ...
    void 수익률_계산() {
        ...
        // when
        double result = LottoHelper.getRateOfReturn(purchaseCount, winningAmount);
    ...
    void 로또_일치_갯수_조회() {
        ...
        // when
        int result = LottoHelper.countWinningNumber(winningLottoNumbers, myLottoNumbers);
