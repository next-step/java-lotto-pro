...
public class LottoResultsTest {
    ...
    void 로또들의_총_수입금_반환() {
        ...
        WinningLotto winningLotto = new WinningLotto(Lotto.generateLotto(new ReadLineLottoNumberGenerator("1,2,3,4,8,10")), LottoNumber.from(34));
    ...
    void 로또들의_총_수입금_없음() {
        Lottos lottos = createLottos();
        WinningLotto winningLotto = new WinningLotto(Lotto.generateLotto(new ReadLineLottoNumberGenerator("1,2,8,10,14,24")), LottoNumber.from(34));
        LottoResults lottoResults = winningLotto.createLottoResults(lottos);
    ...
    void 로또들의_상금별_개수_반환() {
        Lottos lottos = createLottos();
        WinningLotto winningLotto = new WinningLotto(Lotto.generateLotto(new ReadLineLottoNumberGenerator("1,2,3,4,5,10")), LottoNumber.from(34));
        LottoResults lottoResults = winningLotto.createLottoResults(lottos);
        assertAll(
