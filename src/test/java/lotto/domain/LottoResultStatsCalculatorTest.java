...
class LottoResultStatsCalculatorTest {
    ...
    void computeResultStats_winingNothing() {
        final LottoResultStatsCalculator calculator =
            new LottoResultStatsCalculator(tickets, LottoNumbers.of(10, 15, 20, 25, 30, 35));
    ...
    void computeResultStats_winingFirst() {
        final LottoResultStatsCalculator calculator =
            new LottoResultStatsCalculator(tickets, LottoNumbers.of(1, 2, 3, 4, 5, 6));
        final LottoResultStatistics resultStats = calculator.computeLottoResultStats();
    ...
    void computeResultStats_winingSecond() {
        final LottoResultStatsCalculator calculator =
            new LottoResultStatsCalculator(tickets, LottoNumbers.of(1, 2, 3, 4, 5, 45));
        final LottoResultStatistics resultStats = calculator.computeLottoResultStats();
    ...
    void computeResultStats_winingThird() {
        final LottoResultStatsCalculator calculator =
            new LottoResultStatsCalculator(tickets, LottoNumbers.of(1, 2, 3, 4, 40, 45));
        final LottoResultStatistics resultStats = calculator.computeLottoResultStats();
    ...
    void computeResultStats_winingFourth() {
        final LottoResultStatsCalculator calculator =
            new LottoResultStatsCalculator(tickets, LottoNumbers.of(1, 2, 3, 35, 40, 45));
        final LottoResultStatistics resultStats = calculator.computeLottoResultStats();
    ...
    void computeProfitRate_zero() {
        final LottoResultStatsCalculator calculator = new LottoResultStatsCalculator(tickets,
    ...
    void computeProfitRate_one() {
        tickets = Collections.singletonList(
            new LottoTicket(Money.wons(5_000), LottoNumbers.of(1, 2, 3, 4, 5, 6)));
        final LottoResultStatsCalculator calculator = new LottoResultStatsCalculator(tickets,
            LottoNumbers.of(1, 2, 3, 10, 15, 20));
