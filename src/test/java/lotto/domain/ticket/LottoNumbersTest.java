...
class LottoNumbersTest {
    ...
    @Test
    void exceptionTest2() {
        assertThatThrownBy(() -> LottoNumbers.from(Arrays.asList(1, 2, 3, 4, 5))).isInstanceOf(
            IllegalArgumentException.class);
        assertThatThrownBy(() -> LottoNumbers.from(Arrays.asList(1, 2, 3, 4, 5, 6, 7))).isInstanceOf(
            IllegalArgumentException.class);
    }
