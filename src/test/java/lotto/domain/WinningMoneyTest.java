...
class WinningMoneyTest {
    ...
    void threeMatch(int winningMoney) {
    ...
    void fourMatch(int winningMoney) {
    ...
    void fiveMatch(int winningMoney) {
    ...
    void fiveMatchBonusBallMatch(int winningMoney) {
    ...
    void sixMatch(int winningMoney) {
