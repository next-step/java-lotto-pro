...
public class LottoTest {
	...
	@BeforeEach
	void setUp() {
		winlotto = new WinLotto(new Lotto(4, 5, 6, 7, 8, 9), new LottoNumber(10));
	}
	...
	void lottoSecond() {
		Lotto lotto = new Lotto(4, 5, 6, 7, 8, 10);
	...
	void lottoThird() {
		Lotto lotto = new Lotto(4, 5, 6, 7, 8, 11);
	...
	void lottoFourth() {
		Lotto lotto = new Lotto(4, 5, 6, 7, 28, 29);
	...
	void lottoFifth() {
		Lotto lotto = new Lotto(4, 5, 6, 41, 42, 43);
