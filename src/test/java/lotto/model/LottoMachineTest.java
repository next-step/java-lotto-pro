...
class LottoMachineTest {
    ...
    @ParameterizedTest(name = "{0}으로 1000원짜리 로또 구매가능한 수량을 구한다. 수동 구매 량 {1}")
    void buy(int cost, int manualQuantity, int expectedQuantity) {
        Lottos lottos = lottoMachine.buyAuto(cost, manualQuantity);
