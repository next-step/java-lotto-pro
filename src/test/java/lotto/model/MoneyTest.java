...
class MoneyTest {
    ...
    void money_low(String moneyWord) {

        assertThatIllegalArgumentException()
                .isThrownBy(() -> new Money(moneyWord))
    ...
    void money_incorrect_unit(String moneyWord) {
    ...
    void money_incorrect_input_money(String moneyWord) {
