...
class LottoGeneratorTest {
    ...
    void generateLotto1(int input, int expected) {
        LottoGenerator lottoGenerator = LottoGenerator.from(lottoNumberGenerator, Money.from(1000));
    ...
    void generateLotto2(int input, int expected) {
        LottoGenerator lottoGenerator = LottoGenerator.from(lottoNumberGenerator, Money.from(input));
