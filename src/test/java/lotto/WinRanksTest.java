...
public class WinRanksTest {
    ...
    public void 전체로또_당첨순위_확인() {
        Lotto winningLotto = new TestLotto(Arrays.asList(1, 2, 3, 4, 5, 6));

        WinRanks winRanks = new WinRanks();
        winRanks.calculateWinPriceTotals(winningLotto, lottos, new LottoNo(30));
    ...
    public void 전체로또_당첨순위_2등포함_확인() {
        ...
        WinRanks winRanks = new WinRanks();
        winRanks.calculateWinPriceTotals(winningLotto, lottos, new LottoNo(7));
        Map<Rank, Integer> winPriceMap = winRanks.getWinTotals();
    ...
    public void 당첨순위_4등_확인() {
        ...
        WinRanks winRanks = new WinRanks();
        winRanks.calculateWinPriceTotals(winningLotto, lottoRank, new LottoNo(40));
    ...
    public void 당첨순위_2등_확인() {
        Lotto winningLotto = new TestLotto(Arrays.asList(1, 2, 3, 4, 5, 11));
        ...
        WinRanks winRanks = new WinRanks();
        winRanks.calculateWinPriceTotals(winningLotto, lottoRank, new LottoNo(8));
        Map<Rank, Integer> winPriceTotals = winRanks.getWinTotals();
    ...
    public void 전체로또_당첨금액_확인() {
        Lotto winningLotto = new TestLotto(Arrays.asList(1, 2, 3, 4, 5, 6));
        WinRanks winRanks = new WinRanks();
        int winningPrice = winRanks.winningPrice(winningLotto, lottos, new LottoNo(40));
    ...
    public void 전체로또_2등포함_당첨금액_확인() {
        Lotto winningLotto = new TestLotto(Arrays.asList(1, 2, 3, 4, 5, 6));
        WinRanks winRanks = new WinRanks();
        int winningPrice = winRanks.winningPrice(winningLotto, lottos, new LottoNo(7));
