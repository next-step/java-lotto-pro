...
public class LotteryResultTest {
    ...
    void calculateFirstSecondThirdTotalWinningMoney() {
        purchaseLotteryTicket.add(new LotteryTicket(Arrays.asList(1, 2, 3, 4, 5, 12)));
        purchaseLotteryTicket.add(new LotteryTicket(Arrays.asList(1, 2, 3, 4, 5, 7)));
    ...
    void calculateFourthFifthNoMatchTotalWinningMoney() {
        purchaseLotteryTicket.add(new LotteryTicket(Arrays.asList(1, 2, 3, 4, 11, 12)));
        purchaseLotteryTicket.add(new LotteryTicket(Arrays.asList(1, 2, 3, 11, 12, 13)));
        purchaseLotteryTicket.add(new LotteryTicket(Arrays.asList(11, 12, 13, 14, 5, 6)));
