...
public class StringTest {
    ...
    @Test
    @DisplayName("1,2가 주어졌을 때 split을 통해 분리가 가능한지 확인 (갯수)")
    ...
    @Test
    @DisplayName("1,2가 주어졌을 때 split을 통해 분리가 가능한지 확인2")
    void twoNumberSplitTest2() {
        String str = "1,2";
        String[] splitResult = str.split(",");
    ...
    @Test
    @DisplayName("abc에서 charAt을 통해 알파벳 추출, 범위를 벗어났을 때 예외 처리")
    void stringCharAtOutOfBoundsTest() {
        String str = "abc";
