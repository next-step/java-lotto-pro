...
class StringAddCalculatorTest {
	...
	public void SplitAndSum쉼표또는콜론구분자()  {
	...
	public void SplitAndSumCustom구분자()  {
	...
	public void SplitAndSum여러케이스실패(String input)  {
	...
	public void SplitAndSum여러케이스성공(String input, int expected) {
