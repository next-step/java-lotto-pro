...
public class ResultMessage {
	...
	public static final String THREE_MATCH_MESSAGE = "3개 일치 (%s원)- %s개";
	public static final String FOUR_MATCH_MESSAGE = "4개 일치 (%s원)- %s개";
	public static final String FIVE_MATCH_MESSAGE = "5개 일치 (%s원)- %s개";
	public static final String SIX_MATCH_MESSAGE = "6개 일치 (%s원)- %s개";
