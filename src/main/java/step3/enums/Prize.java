...
public enum Prize {
    ...
    SECOND_PLACE(FIRST_PLACE.correct - 1, new Money(1500000)),
    THIRD_PLACE(SECOND_PLACE.correct - 1, new Money(50000)),
    FORTH_PLACE(THIRD_PLACE.correct - 1, new Money(5000));
