...
public enum ErrorMessage {
    ...
    LOTTO_WINNING_NUMBER_COUNT(String.format("당첨 번호는 %d개 입니다.", LottoProperty.LOTTO_COUNT)),
    LOTTO_WINNING_NUMBER_RANGE(String.format("당첨 번호는 %d부터 %d 사이의 숫자입니다.", LottoProperty.LOTTO_START_NUMBER, LottoProperty.LOTTO_END_NUMBER));
