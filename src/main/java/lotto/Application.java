...
public class Application {
    ...
    public static void main(final String[] args) {
        ...
        ResultView.printPurchasedLottoNumbers(customer.getPurchasedLottoNumbers());
    ...
    private static List<LottoNumbers> createAutoLottoNumbers(final int count) {
        final LottoNumbersSupplier lottoNumbersSupplier = new UniqueLottoNumbersSupplier();
    ...
    private static int parseInt(final String value) {
        try {
            ...
            throw new LottoException("value should be numeric", numberFormatException);
        }
    }
