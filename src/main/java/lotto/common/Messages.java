...
public class Messages {
    ...
    public static String getPurchasedLottoCount(int manualLottoCount, int autoLottoCount) {
        return String.format("수동으로 %d장, 자동으로 %d개를 구매했습니다.", manualLottoCount, autoLottoCount);
    }
}
