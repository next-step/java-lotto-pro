...
import static lotto.domain.Lotto.COLLECT_ADD_NUMBER;
...
public class InputValidator {
    public static final String ERROR_MESSAGE_DUPLICATED_NUMBER = "[ERROR] 유효하지 않은 로또 번호(중복)";
    ...
    public static void validateLottoNumber(String input) {
        ...
        validateLottoNumberRange(Integer.parseInt(input));
    }
    ...
    public static void validateDuplicateInt(List<Integer> numbers) {
    ...
    public static void validateDuplicateBonusBall(Lotto winningNumbers, LottoNumber bonusBall) {
        if (winningNumbers.containNumbers(bonusBall) == COLLECT_ADD_NUMBER) {
            try {
