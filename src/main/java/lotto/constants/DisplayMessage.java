...
public class DisplayMessage {
    ...
    public static final String INPUT_MANUAL_COUNT = "%n수동으로 구매할 로또 수를 입력해 주세요.%n";
    public static final String INPUT_MANUAL_NUMBERS = "%n수동으로 구매할 번호를 입력해 주세요.%n";
    public static final String PURCHASE_LOTTO_COUNT = "%n수동으로 %s장, 자동으로 %s장을 구매했습니다.%n";
    ...
    public static final String GAIN_AND_POST_POSITION = "이득이";
    public static final String PRINCIPAL_AND_POST_POSITION = "원금이";
}
