...
public class ResultView {
    ...
    public void printGameStart(int amount, List<Lottery> userLottery) {
    ...
    public void printGameResult(Map<Rank, Long> gameResult) {
        System.out.println(GAME_RESULT_MESSAGE);
        for (Rank result : gameResult.keySet()) {
            System.out.printf(GAME_STATISTICS_MESSAGE,
                    result.getMatchCount(), result.getPrice(), gameResult.get(result));
        }
    }
