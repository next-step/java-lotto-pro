...
public class OutputProvider {
    ...
    public static void printRewards(Rewards rewards) {
        ...
        System.out.println(FIFTH_MATCH_COUNT + rewards.count(Rank.FIFTH));
        System.out.println(FOURTH_MATCH_COUNT + rewards.count(Rank.FOURTH));
        System.out.println(THIRD_MATCH_COUNT + rewards.count(Rank.THIRD));
        System.out.println(FIRST_MATCH_COUNT + rewards.count(Rank.FIRST));
        System.out.println(TOTAL_RATE_OF_REWARD + rewards.calculateRateReward());
    }
}
