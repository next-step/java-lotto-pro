...
public class OutputView {
    ...
    public static void outputResult(Map<Rank, Integer> resultMap) {
        ...
        System.out.println("---------");
        System.out.println("3개 일치 (5000원)- " + resultMap.get(Rank.FIRST) + "개");
        System.out.println("4개 일치 (50000원)- " + resultMap.get(Rank.SECOND) + "개");
        System.out.println("5개 일치 (1500000원)- " + resultMap.get(Rank.THIRD) + "개");
        System.out.println("6개 일치 (2000000000원)- " + resultMap.get(Rank.FOURTH) + "개");
    }
