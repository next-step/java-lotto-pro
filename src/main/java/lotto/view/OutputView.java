...
public class OutputView {
    ...
    private static final String MSG_RETURN_RATE = "총 수익률은 %.2f입니다.";

    private static final String MSG_LOSS = "(기준이 1이기 때문에 결과적으로 손해라는 의미임)";
    ...
    public static void printResult(LottoResult result) {
        ...
        String msg = MSG_RETURN_RATE;
        if (result.getReturnRate() < 1) {
            msg += MSG_LOSS;
        }
        print(String.format(msg, result.getReturnRate()));
    }
