...
public class OutputView {
    private static final String SIZE_FORMAT = "수동으로 %s장, 자동으로 %s개를 구매했습니다.";
    ...
    public static void printLottoCount(int lottoQuantity, int manualQuantity) {
        System.out.println(String.format(SIZE_FORMAT, manualQuantity, lottoQuantity - manualQuantity));
    }
