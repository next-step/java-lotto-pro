...
public class ErrorMessage {
	...
	public static final String INVALID_INPUT_CUSTOM_LOTTO_COUNT = ERROR_PREFIX + "수동으로 구매할 로또 개수가 올바르지 않습니다. count=%s";
	public static final String INVALID_INPUT_LOTTO_NUMBERS = ERROR_PREFIX + "입력한 로또 번호가가 올바르지 않습니다. numbers=%s";
