...
public class LottoWinningNumberInputView {
    ...
    public LottoWinningNumberRequestDto submit() {
        try {
    ...
    private HashSet<Integer> getLottoInningNumber() {
    ...
    private void validateNotNull(final String winningNumberStr) {
    ...
    private HashSet<Integer> toSet(final String winningNumberStr) {
    ...
    private int parseLottoNumber(String winningNumber) {
    ...
    private int parseInt(final String winningNumber) {
        try {
