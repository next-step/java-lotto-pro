...
public class ResultView {
    ...
    public static void result (LottoResult result) {
        ...
        System.out.println("3개 일치 (5000원)- " + getHitCount(hitList, CompareEnum.Fourth) + "개");
        System.out.println("4개 일치 (50000원)- " + getHitCount(hitList, CompareEnum.Third) + "개");
        System.out.println("5개 일치 (1500000원)- " + getHitCount(hitList, CompareEnum.Second) + "개");
