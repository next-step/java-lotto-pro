...
* Model
  * 보너스 볼을 입력받는 기능
    * 보너시 볼도 다른 숫자와 동일하게 1~45사이의 숫자로 입력 받아야 한다.
    * 보너스 볼을 입력받아 상태값을 관리해야한다.
  * 보너스 볼 포함한 당첨 번호 통계 내는 기능
    * 5개가 일치하고 보너스 볼까지 일치하는 경우를 추가해야한다.
* View
  * 보너스 볼을 입력받는 UI
  * 보너스 볼에 대한 2등 당첨 통계결과 추가 출력하는 UI
