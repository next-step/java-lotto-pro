...
* LottoNumbers
  * [ ] 하나의 로또번호는 중복된 숫자를 포함할 수 없다.
* WinningLottoNumbers
  * [ ] 당첨 로또 번호는 보너스 숫자를 포함하면 안된다.
* LottoQuantity
  * [ ] 로또 개수는 1개 이상이어야 한다.
* PurchaseAmount
  * [ ] 구매 수량은 음수가 될 수 없다.
...
### 피드백
* [ ] 로또를 생성하는 부분을 LottoQuantity -> LottoGenerator로 옮기는건 어떠한가?
* [ ] LottoRank는 단순한 상수가 아닌 비즈니스 로직을 담고 있으므로 model 패키지로 옮기는건 어떠한가?
