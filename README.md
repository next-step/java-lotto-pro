...
#### 수동 시도 횟수 입력
- [ ] 수동 시도 횟수를 입력받는다.
  - [ ] 해당 값은 구매할 수 있는 최대 구매 횟수 내의 값이어야 한다.
#### 수동 입력
- [ ] 콤마(,) 구분의 로또 번호를 입력받는다.
  - [ ] 입력받은 값의 검증은 "지난 주 당첨번호 입력"과 동일하다.
#### 생성된 로또 번호 출력 변경
- [ ] 생성된 로또 티켓 갯수 출력시 수동/자동 나누어 표시한다.
- [ ] 생성된 로또 티켓 출력시 모두 합쳐져서 출력되어야 한다.
  - [ ] 수동으로 입력된 로또 티켓이 먼저 출력되어야 한다.
