...
#### LottoGenerator
- [X] 1 ~ 45 범위 내에서 숫자 6개로 구성된 숫자세트를 생성할 수 있다.
#### RandomLottoGenerator (extends LottoGenerator)
- [X] 1 ~ 45 범위 내에서 랜덤 숫자 6개로 구성된 숫자세트를 생성할 수 있다.
#### ManualLottoGenerator (extends LottoGenerator)
- [X] 1 ~ 45 범위 내에서 입력받은 숫자 6개로 구성된 숫자세트를 생성할 수 있다.    
#### LottoNumber
...
- [X] 당첨 개수 및 당첨 금액을 관리한다.  
  - [X] 보너스 볼이 일치하는 Case도 관리한다.   
#### Ranks
- [X] 당첨내역에 해당하는 필드를 포함한다.
- [X] 당첨내역을 조회할 수 있다.
#### MatchCount
- [X] 로또번호 일치 개수를 관리한다. 
  - [X] 보너스 볼 일치 개수 필드를 포함한다.
#### Quantity
- [X] 수동과 자동 로또 구매 수량 필드를 포함한다.
#### PurchaseType
- [X] 구매타입을 관리한다.
#### Yields
- [X] 수익 필드를 포함한다.
...
#### ResultView
- [X] 로또 구매 수량을 출력한다.
  - [X] 수동과 자동 로또 각 구매 수량을 출력한다.   
- [X] 구매한 로또번호 리스트를 출력한다. 
- [X] 당첨 통계 결과를 출력한다.
  - [X] 당첨 번호 5개 및 보너스 볼 일치한 Case도 포함하여 출력한다.   
