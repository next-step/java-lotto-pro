...
- [x] 정적 팩토리 메소드를 사용하는 LotteryNumbers 의 기본 생성자의 접근 제어자는 private
  - [x] WinningNumber 에서 LotteryNumbers 를 생성할 때 정적 팩토리 추가하기 
- [x] WinningNumber 와 LotteryNumbers 를 바로 매치를 비교하여 Rank 가져오기
- [x] Indent 1 유지
- [x] 모호한 의미 전달을 막기 위한 메소드 이름 변경
- [x] stream 라인 분리를 위한 가독성 향상
