...
### 프로그래밍 요구사항
 ...
 - 자바 코드 컨벤션을 지키면서 프로그래밍한다.
   1. 참고문서: https://google.github.io/styleguide/javaguide.html 
...
### 구현 기능 리스트 
1. 메인 기능 목록
- [ ] 로또번호에 사용할 유효한 숫자(1 ~ 45이하의 숫자)를 가진 볼 객체를 만든다.
- [ ] 공 6개가 담긴 로또 객체를 만든다.
- [ ] 로또들이 담긴 로또 리스트 객체를 만든다.
- [ ] 당첨 결과를 확인하는 기능을 구현한다.
- [ ] 수익률을 계산하는 기능을 구현한다.
- [ ] 구입 금액에 따라 로또를 구매하는 기능을 구현한다. 

2. UI 관련 기능 목록
- [ ] 로또 구입 금액 입력 받는 기능을 구현한다.
- [ ] 지난 주 당첨 번호를 입력 받는 기능을 구현한다.
- [ ] 입력값의 유효성을 체크한다.
- [ ] 당첨 통계를 출력하는 기능을 구현한다.
- [ ] 수익률을 출력하는 기능을 구현한다.