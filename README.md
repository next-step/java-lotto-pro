...
* [ ] 기능 요구사항 정리
* [ ] 로또 번호 생성기 캐싱 사용
* [ ] 로또 번호 static factory 메서드 적용
* [ ] 로또 랭크 Null 리턴이 아닌 의미있는 값 적용
* [ ] 로또 목록 누락된 변수 제거
* [ ] 겹치는 상수 공통으로 사용
* [ ] LottoRank.generateRankInfo() 작업 위치 변경
* [ ] 총 금액을 구하는 로직 도메인 쪽으로 변경
* [ ] 로또 번호 생성기 도메인 패키지로 이동
* [ ] 로또 목록 로또 번호 생성 랜덤값 의존
* [ ] 로또 목록 생성자 private 적용