...
### 구현 필요기능
1. 로또번호 랜덤 생성기능 구현
2. 로또번호 validation 구현
3. 로또번호 Set 생성 및 중복 체크기능 구현
4. 로또 구매금액 입력받는 기능 구현
5. 로또 구매금액내 로또 Set 생성 기능 구현
6. 구입된 로또 Set 출력기능 구현
7. 지난 주 당첨번호 입력받는 기능 구현
8. 당첨여부 확인 기능 구현
9. 수익률 계산 기능 구현
10. 당첨현황 및 수익률 출력 기능 구현